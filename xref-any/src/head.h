...
#define BIN_LICENSE_ERROR_MSG "You are using Xrefactory beyond its free evaluation period.\nXrefactory is a shareware. You can purchase legal user license\nfor $29 at the address: http://www.xref-tech.com/xrefactory\n"
